...
namespace TodoApi2
{
    public class PurchaseReceiveReportRepository : IPurchaseReceiveReportRepository
    {
        ...
        public ResultDTO GetPurchaseReceiveReport(Login c)
        {
            ...
            DataSet ds = xDS.ExecProcedureDataSet(SPName.sp_PurchaseReceiveReport, alParameters);
