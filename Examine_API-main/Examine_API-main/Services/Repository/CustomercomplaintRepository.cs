...
namespace TodoApi2
{
    public class CustomercomplaintRepository : ICustomercomplaintRepository
    {
         ...
         MsSQLDBUtility xDS = new MsSQLDBUtility(AccessToDb.ConnectionString_GBBPM);
        ...
        public ResultDTO GetCustomercomplaint(Login c)
        {
        ...
        //    alParameters.Add(new object[3] { "@Value", SqlDbType.NVarChar, c?.Value });
            DataSet ds = xDS.ExecProcedureDataSet(SPName.sp_Customer_Complaint, alParameters);
