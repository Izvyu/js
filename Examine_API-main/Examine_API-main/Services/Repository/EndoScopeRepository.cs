...
namespace TodoApi2
{
    public class EndoScopeRepository : IEndoScopeRepository
    {
        ...
        public ResultDTO GetEndoScope(Login c)
        {
        ...
        //    alParameters.Add(new object[3] { "@Value", SqlDbType.NVarChar, c?.Value });
            DataSet ds = oDS.ExecProcedureDataSet(SPName.prc_sp_query_ogd_sum, alParameters);
