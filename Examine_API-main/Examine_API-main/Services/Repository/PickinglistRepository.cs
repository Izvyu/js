...
namespace TodoApi2
{
    public class PickinglistRepository : IPickinglistRepository
    {
        ...
        public ResultDTO GetPickinglist(Login c)
        {
        ...
        //    alParameters.Add(new object[3] { "@Value", SqlDbType.NVarChar, c?.Value });
            DataSet ds = xDS.ExecProcedureDataSet(SPName.sp_query_Pickinglist, alParameters);
