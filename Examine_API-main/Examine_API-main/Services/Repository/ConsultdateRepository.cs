...
namespace TodoApi2
{
    public class ConsultdateRepository : IConsultdateRepository
    {
        ...
        public ResultDTO  GetConsultdate(Login c)
        {
        ...
        //    alParameters.Add(new object[3] { "@Value", SqlDbType.NVarChar, c?.Value });
            DataSet ds = oDS.ExecProcedureDataSet(SPName.prc_sp_query_consultdate, alParameters);
