...
namespace TodoApi2
{
    public class MedRecordRepository : IMedRecordRepository
    {
        ...
        public ResultDTO GetMedRecord(Login c)
        {
        ...
        //    alParameters.Add(new object[3] { "@Value", SqlDbType.NVarChar, c?.Value });
            DataSet ds = oDS.ExecProcedureDataSet(SPName.prc_sp_query_MedicalRecords3, alParameters);
