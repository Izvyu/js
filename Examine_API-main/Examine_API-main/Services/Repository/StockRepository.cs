...
namespace TodoApi2
{
    public class StockRepository : IStockRepository
    {
        ...
        public ResultDTO GetStock(Login c)
        {
            ...
            using (SqlConnection connection = new SqlConnection(oDS.ConnectionString))
            {
                ...
                using (SqlCommand command = new SqlCommand())
                {
                    ...
                    command.CommandText = @"select case fact_id
                                         ...
                                         fact_id,matno,mat_name,mat_specnm,unitnm,wareno,warenm,stoplaceno,stoplacenm,stock_date,sto_qty from wh_stock  WHERE matno LIKE 'A%'";
