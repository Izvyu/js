...
namespace TodoApi2
{
    public class ReceipttimeRepository : IReceipttimeRepository
    {
        ...
        public ResultDTO GetReceipttime(Login c)
        {
            ...
            DataSet ds = xDS.ExecProcedureDataSet(SPName.prc_sp_query_Receipt_time, alParameters);
