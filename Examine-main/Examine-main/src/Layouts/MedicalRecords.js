...
const MedicalRecords = props => {
    ...
    const [StartDate, setStartDate] = React.useState(new Date().toJSON().slice(0, 10).replace(/-/g, '/'))
    ...
    const handleQuery = () => {
        ...
        if (StartDate !== '') {
            ...
            PF.instance({
                method: "post",
                url: PF.url2 + "/MedicalRecord/GetData",
                data: Qs.stringify({
                    Action: "1",
                    parameter: {
                        StartDate: StartDate,
        ...
        <>
            ...
            <Grid container spacing={0}>
                <Grid item xs={12} md={6}>
                    <div className="ag-theme-alpine" style={{ height: 950, width: 880 }}>
                        <AgGridReact
                            ref={gridRef}
                            rowData={todayList}
