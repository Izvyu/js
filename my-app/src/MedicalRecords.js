...
const MedicalRecords = props => {
    ...
    const [columnDefs] = React.useState([
        ...
        { field: 'barcode', headerName: "條碼號", width: 150, tooltipField: 'barcode' },
        { field: 'PersonalId', headerName: "身份證號", width: 150, tooltipField: 'PersonalId' },
        { field: 'UserName', headerName: "姓名", width: 150, tooltipField: 'UserName' },
        { field: 'checkdate', headerName: "健檢日", width: 150, tooltipField: 'checkdate' },
        { field: 'customerName', headerName: "專案名稱", width: 150, tooltipField: 'customerName' },
        { field: 'Birthday', headerName: "生日", width: 150, tooltipField: 'Birthday' },
    ...
    const handleQuery = () => {
        ...
        if (CheckDate !== '') {
            ...
            PF.instance({
                method: "post",
                url: PF.url2 + "/Minmax/Getcheckdate",
                data: Qs.stringify({
                    Action: "1",
                    parameter: {
                        CheckDate: CheckDate,
        ...
        <>
            ...
            <Grid container spacing={0}>
                <Grid item xs={12} md={6}>
                    <div className="ag-theme-alpine" style={{ height: 950, width: 1230 }}>
                        <AgGridReact
                            ref={gridRef}
                            rowData={todayList}
