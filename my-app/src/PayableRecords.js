...
const PayableRecords = props => {
    ...
    const [columnDefs] = React.useState([
        ...
        { field: 'payable_no', headerName: "單號", width: 140, tooltipField: 'payable_no' },
        { field: 'supnm', headerName: "供應商", width: 180, tooltipField: 'supnm' },
        { field: '發票總金額', headerName: "發票總金額", width: 160, tooltipField: '發票總金額' },
        { field: '供應商應付金額', headerName: "供應商應付金額", width: 160, tooltipField: '供應商應付金額' },
        { field: 'purtype_name', headerName: "類別", width: 130, tooltipField: 'purtype_name' },
    ...
    const handleQuery = () => {
        ...
        // console.log(no)
            PF.instance({
                method: "post",
                url: PF.url2 + "/Payable/GetPayable",
                data: Qs.stringify({
                    Action: "1",
                    parameter: {
                        startDate: startDate,
