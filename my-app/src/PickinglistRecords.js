...
const ReceipttimeRecords = props => {
    ...
    const [columnDefs] = React.useState([
        ...
        { field: 'matno', headerName: "品號", width: 140, tooltipField: 'matno' },
        { field: 'mat_name', headerName: "品名", width: 340, tooltipField: 'mat_name' },
        { field: 'mat_specnm', headerName: "規格", width: 200, tooltipField: 'mat_specnm' },
        { field: 'unitnm', headerName: "單位", width: 80, tooltipField: 'unitnm' },
        { field: 'send_qty', headerName: "領用量", width: 120, tooltipField: 'send_qty' },
        { field: 'warenm', headerName: "庫別", width: 180, tooltipField: 'warenm' },
        { field: 'doc_date', headerName: "單據日期", width: 150, tooltipField: 'doc_date' },
        { field: 'stoplacenm', headerName: "儲位", width: 180, tooltipField: 'stoplacenm' },
    ...
    const handleQuery = () => {
        ...
        // console.log(no)
            PF.instance({
                method: "post",
                url: PF.url2 + "/Pickinglist/GetPickinglist",
                data: Qs.stringify({
                    Action: "1",
                    parameter: {
                        startDate: startDate,
