...
const RepairRecords = props => {
    ...
    const [columnDefs] = React.useState([
        ...
        { field: 'doc_date', headerName: "日期", width: 120, tooltipField: 'doc_date'}, 
        { field: 'fact_id', headerName: "廠別", width: 110, tooltipField: 'fact_id' },
        { field: 'zwmtap_doc_no', headerName: "請修單號", width: 150, tooltipField: 'zwmtap_doc_no' },
        { field: 'ap_usernm', headerName: "申請人", width: 120, tooltipField: 'ap_usernm' },
        { field: 'ap_dept_name', headerName: "維修地點", width: 150, tooltipField: 'ap_dept_name' },
        // { field: 'mt_addr', headerName: "維修地點", width: 120, tooltipField: 'mt_addr' },
        { field: 'mtap_remark', headerName: "請修說明", width: 250, tooltipField: 'mtap_remark' },
        { field: 'remark', headerName: "備註", width: 250, tooltipField: 'remark' },
        { field: 'audit_flag1', headerName: "審核", width: 100, tooltipField: 'audit_flag1' },
        ...
        <>
            ...
            <Grid container spacing={0}>
                ...
                <div style={containerStyle}>
                    <div  className="ag-theme-alpine" style={{ height: 670, width: 1270 }}>
                        <AgGridReact
                            ref={gridRef}
                            rowData={todayList}
