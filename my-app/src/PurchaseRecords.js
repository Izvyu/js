...
const PurchaseRecords = props => {
    ...
    const [columnDefs] = React.useState([
        ...
        { field: 'com_id', headerName: "公司", width: 100, tooltipField: 'com_id' },
        ...
        { field: 'req_dept_name', headerName: "請購部門", width: 120, tooltipField: 'req_dept_name' },
        { field: 'pur_req_doc_no', headerName: "請購單號", width: 150, tooltipField: 'pur_req_doc_no' },
        { field: 'doc_date', headerName: "請購日期", width: 120, tooltipField: 'doc_date' },
        { field: 'supnm', headerName: "供應商", width: 150, tooltipField: 'supnm' },
        // { field: 'pur_supno', headerName: "供應商代號", width: 150, tooltipField: 'pur_supno' },
        { field: 'matno', headerName: "品號", width: 120, tooltipField: 'matno' },
        { field: 'mat_name', headerName: "品名", width: 150, tooltipField: 'mat_name' },
        { field: 'req_qty', headerName: "請購數量", width: 100, tooltipField: 'req_qty' },
    ...
    const handleQuery = () => {
        ...
        if (CheckDate !== '') {
            ...
            PF.instance({
                method: "post",
                url: PF.url2 + "/purchase/Getcheckpurchase",
                data: Qs.stringify({
                    Action: "1",          
                }),
