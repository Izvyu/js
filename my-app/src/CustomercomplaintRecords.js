...
const CustomercomplaintRecords = props => {
...
const { RangePicker } = DatePicker;
    ...
    const [columnDefs] = React.useState([
        ...
        { field: '送審日期', headerName: "送審日期", width: 120, tooltipField: '送審日期'}, 
        { field: '客訴單號', headerName: "客訴單號", width: 120, tooltipField: '客訴單號'},
        { field: '顧客姓名', headerName: "顧客姓名", width: 120, tooltipField: '顧客姓名'},
        { field: '客訴日期', headerName: "客訴日期", width: 120, tooltipField: '客訴日期'},
        { field: '電話', headerName: "電話", width: 110, tooltipField: '電話'},
        { field: '記錄人', headerName: "記錄人", width: 120, tooltipField: '記錄人'},
        { field: '醫師', headerName: "醫師", width: 120, tooltipField: '醫師'},
        { field: '客訴來源', headerName: "客訴來源", width: 120, tooltipField: '客訴來源'},
        { field: '施作療程項目/公司行號/專案名稱', headerName: "施作療程項目/公司行號/專案名稱", width: 250, tooltipField: '施作療程項目/公司行號/專案名稱'},
        { field: '客訴內容及原因', headerName: "客訴內容及原因", width: 150, tooltipField: '客訴內容及原因' },
        { field: '處理狀況', headerName: "處理狀況", width: 120, tooltipField: '處理狀況' },
        { field: '改善方案', headerName: "改善方案", width: 120, tooltipField: '改善方案' },
        { field: '批示', headerName: "批示", width: 130, tooltipField: '批示' },
    ...
    const handleQuery = () => {
        ...
        // console.log(no)
            PF.instance({
                method: "post",
                url: PF.url2 + "/Customercomplaint/GetCustomercomplaint",
                data: Qs.stringify({
                    Action: "1",
                    parameter: {
                        startDate: startDate,
...
export default CustomercomplaintRecords 