...
const ReceipttimeRecords = props => {
    ...
    const [columnDefs] = React.useState([
        ...
        { field: 'matrec_doc_no', headerName: "單號", width: 140, tooltipField: 'matrec_doc_no' },
        { field: 'supnm', headerName: "供應商", width: 160, tooltipField: 'supnm' },
        { field: 'req_dept_name', headerName: "部門", width: 120, tooltipField: 'req_dept_name' },
        { field: 'purtype_name', headerName: "類別", width: 120, tooltipField: 'purtype_name' },
        { field: 'doc_date', headerName: "單據日期", width: 120, tooltipField: 'doc_date' },
        { field: 'audit_flag2', headerName: "送審", width: 100, tooltipField: 'audit_flag2' },
    ...
    const handleQuery = () => {
        ...
        // console.log(no)
            PF.instance({
                method: "post",
                url: PF.url2 + "/Receipttime/GetReceipttime",
                data: Qs.stringify({
                    Action: "1",
                    parameter: {
                        startDate: startDate,
...
export default ReceipttimeRecords 