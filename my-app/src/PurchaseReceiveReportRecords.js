...
const PayableRecords = props => {
    ...
    const [columnDefs] = React.useState([
        ...
        { field: '公司', headerName: "公司", width: 120, tooltipField: '公司'}, 
        { field: 'pur_doc_no', headerName: "單號", width: 140, tooltipField: 'pur_doc_no' },
        { field: 'supnm', headerName: "供應商", width: 200, tooltipField: 'supnm' },
        { field: 'matno', headerName: "品號", width: 130, tooltipField: 'matno' },
        { field: 'mat_name', headerName: "品名", width: 240, tooltipField: 'mat_name' },
        { field: 'mat_specnm', headerName: "規格", width: 200, tooltipField: 'mat_specnm' },
        { field: 'pur_unitnm', headerName: "單位", width: 100, tooltipField: 'pur_unitnm' },
        { field: 'price', headerName: "價格", width: 130, tooltipField: 'price' },
        { field: 'pur_qty', headerName: "數量", width: 130, tooltipField: 'pur_qty' },
         { field: 'doc_date', headerName: "單據日期", width: 130, tooltipField: 'doc_date' },
        // { field: 'audit_flag1', headerName: "確認", width: 100, tooltipField: 'audit_flag1' },
        // { field: 'audit_date2', headerName: "送審時間", width: 180, tooltipField: 'audit_date2' },
        // { field: 'audit_date1', headerName: "確認時間", width: 180, tooltipField: 'audit_date1' },
        // { field: 'audit_date_diff', headerName: "收貨時間", width: 120, tooltipField: 'audit_date_diff' },
    ...
    const handleQuery = () => {
        ...
        // console.log(no)
            PF.instance({
                method: "post",
                url: PF.url2 + "/PurchaseReceiveReport/GetPurchaseReceiveReport",
                data: Qs.stringify({
                    Action: "1",
                    parameter: {
                        startDate: startDate,
